    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>Belajarphp</b>.net</span>
        </a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li>
                <?php echo anchor('inbox','<i class="fa fa-envelope"></i> <span>PESAM MASUK</span>
                <small class="label pull-right bg-red">3</small>'); ?>
              </a>
            </li>

            <li>
                <?php echo anchor('outbox','<i class="fa fa-envelope-o"></i> <span>PESAN KELUAR</span>
                <small class="label pull-right bg-red">3</small>'); ?>
            </li>
            <li>
                <?php echo anchor('outbox/write','<i class="fa fa-external-link"></i> <span>KIRIM PESAN</span>
                <small class="label pull-right bg-red">3</small>'); ?>
            </li>

            <li>
                <?php echo anchor('phonebook','<i class="fa fa-phone-square"></i> <span>PHONEBOOK</span>
                <small class="label pull-right bg-red">3</small>'); ?>
            </li>

            <li>
                <?php echo anchor('group','<i class="fa fa-users"></i> <span>PHONEBOOK GROUP</span>
                <small class="label pull-right bg-red">3</small>'); ?>
            </li>
