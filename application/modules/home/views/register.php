    ...
    <div class="row">
        <div class="col-md-2 col-md-offset-4 text-center">
            <a href="#" data-toggle="collapse" data-target="#collapsePelapor" aria-expanded="false" aria-controls="collapsePelapor">
                <img src="<?php echo base_url() ?>template/assets/images/pelapor-icon.png" width="125" class="well signup-form" alt="">
        ...
        <div class="col-md-2 text-center">
            <a href="#" data-toggle="collapse" data-target="#collapseRelawan" aria-expanded="false" aria-controls="collapseRelawan">
                <img src="<?php echo base_url() ?>template/assets/images/volunteer-icon.png" width="125" class="well signup-form" alt="">
    ...
    <div class="row collapse" id="collapsePelapor">
        ...
        <div class="col-md-8 col-md-offset-2 text-center">
            ...
            <div class="well signup-form">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="kv-avatar center-block" style="width:200px">
                                <input id="avatar" name="userfile" type="file" class="file-loading">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                            <input type="hidden" name="jenis" value="pelapor">
                        ...
                        <div class="form-group">
                            <input type="text" name="alamat" class="form-control input-md" placeholder="Alamat">
                        </div>
                        <div class="form-group">
                ...
                <button type="submit" name="submit" class="btn btn-primary btn-block btn-lg">Daftarkan</button>
                </form>
            </div>
        </div>
    </div>
