            ...
            <div id="myCarousel" class="carousel slide">
                <div class="carousel-inner">
                    <div class="active item">
                        <img src="assets/images/kebakaran.jpg" alt="Slide1" />
                    </div>
                </div>
            </div>
        </section>
    ...
    <div class="container ">
        <div class="row">
            <div class="col-md-8 listing-content">
                <h3>Tentang Permasalahan Ini</h3>
                <p>Kabut asap pekat menyelimuti Kota Palembang, Sumatera Selatan. Kualitas udara memburuk selama berbulan-bulan hingga masuk dalam kategori berbahaya.</p>
                ...
                <p>
                  <div class="media media-tweet">
                    <div class="media-left">
                      <a href="#">
                        <img class="media-object" src="assets/images/dummy-agent.png" data-holder-rendered="true" style="width: 64px; height: 64px;">
                      </a>
                    </div>
                ...
                <p>
                  <div class="media media-tweet">
                    <div class="media-left">
                      <a href="#">
                        <img class="media-object" src="assets/images/dummy-sms.png" data-holder-rendered="true" style="width: 64px; height: 64px;">
                      </a>
                    </div>
                    <div class="media-body">
                      <h5 class="media-heading">0857-1010-44xx
                      <small class="pull-right">10 Desember 2015</small></h5>
                      Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. 
                    </div>
                  </div>
            ...
            <div class="col-md-4">
                <div class="agent-information">
                    <img src="assets/images/info-icon.jpg" class="agent-picture img-circle">
